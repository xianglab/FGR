...
string molecule = "BMA"; //Fulvene, BMA or MIA
const int n_omega = 78;//78; //number of normal modes, Fulvene=30; BMA=78; MIA=96
double Delta_11 = 0; //donor
double Delta_22 = 2.9255e-02;//2.9255e-02; //acceptor. Fulvene=-0.98911; BMA=2.9255e-02; MIA=2.4615e-03(reversed)
const double fs2au = 41.341105; //1 fs = 41.34 a.u.
const double kT2au = 3.168429139e-6;// kT(1 Kelvin) = 3.2e-6 a.u.

double temperature = 0; //K  NOTICE: Temperature = 0K in Exact and LSC and PW-AV
const int LEN = 1024; //FFT time steps
double DeltaT_fs = 0.15;
