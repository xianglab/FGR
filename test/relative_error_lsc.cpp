...
string nameapp = "Gau_b1e1_5e4_";
double DeltaE_max = 6; // cutoff max of DeltaE/h in FFT for relative error
...
int main (int argc, char *argv[]) {
    ...
    //outfile << corr1_orig[i]*LEN*DeltaT*DAcoupling*DAcoupling << endl;
    //outfile.close();
    //outfile.clear();
