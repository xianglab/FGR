...
const int MCN = 1000000;//1000000; //Monte Carlo sampling number

const int N = n_omega; //number of degrees of freedom
const int LEN = 512;// 512 for ohmic 1024 for gaussian; //number of t choices in FFT
const int STEPS = 1;//10;//50; //for correlation function skip steps
const double DeltaT= 0.2; // 0.1 for ohmic 0.3 for gaussian ; //FFT time sampling interval
