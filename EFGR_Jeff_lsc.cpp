...
int main (int argc, char *argv[]) {
    ...
    outfile3.open((emptystr + "QMLSC_EFGR_Jeff_C(t)_" + nameapp + ".dat").c_str());
    ...
    outfile3.open((emptystr + "QMLSC_EFGR_Jeff2_C(t)_" + nameapp + ".dat").c_str());
    for (i = 0; i < nn; i++) corr1[i] = corr2[i] = 0; //zero padding
    for (i = 0; i < LEN; i++) {
        t = T0 + DeltaT * i;
        integ_re[0] =0;
